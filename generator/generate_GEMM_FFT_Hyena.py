...
def FFT(counter, name):
    for i in range(stage):
        ...
        kernel.gemm_input1_weight.M = 2*r
        kernel.gemm_input1_weight.K = 2*r
        kernel.gemm_input1_weight.N = int(seq/r)
        ...
        kernel.gemm_input1_weight.sram_extra = int(seq/r)*r**2*2*word
        kernel.gemm_input1_weight.dram_extra = int(seq/r)*r**2*2*word
...
# write to text file
with open('generator/GEMM_FFT_Hyena.txt', "w") as file:
